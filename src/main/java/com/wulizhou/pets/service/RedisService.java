package com.wulizhou.pets.service;
...
public class RedisService {
     ...
     * @param value
     */
    public <K, V> void hmSet(String key, K hashKey, V value) {
     ...
     * @return
     */
    public <K, V> V hmGet(String key, K hashKey) {
        HashOperations<String, K, V> hash = redisTemplate.opsForHash();
     ...
     * @param v
     */
    public <V> void lPush(String k, V v) {
